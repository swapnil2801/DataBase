...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	private String getEmployeeRecordById(int targetId) throws Exception
	{
	    BufferedReader reader = new BufferedReader(new FileReader(fo));
        String line;
        while ((line = reader.readLine()) != null) 
        {
            int id = extractIdFromLine(line);
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	// int i = Integer.parseInt(bobj.readLine());
